...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "Poc_OpInvokeElement", isSet = false )
    public class Poc_OpInvokeElement implements IASN1PreparedElement {
	...
	private InstNumber op_instance_no = null;
        ...
        @ASN1Element ( name = "op-mod-type", isOptional =  false , hasTag =  false  , hasDefaultValue =  false  )
    
	private Poc_OpModType op_mod_type = null;
	...
	private AttributeList attributes = null;
        ...
        public Poc_OpModType getOp_mod_type () {
            return this.op_mod_type;
        }

        

        public void setOp_mod_type (Poc_OpModType value) {
            this.op_mod_type = value;
        }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(Poc_OpInvokeElement.class);
