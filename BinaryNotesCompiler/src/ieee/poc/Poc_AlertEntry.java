...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "Poc_AlertEntry", isSet = false )
    public class Poc_AlertEntry implements IASN1PreparedElement {
	...
	private HANDLE obj_reference = null;
        ...
        @ASN1Element ( name = "instance", isOptional =  false , hasTag =  false  , hasDefaultValue =  false  )
    
	private InstNumber instance = null;
  ...
  @ASN1Any( name = "" )
	...
	private byte[] alert_info = null;
        ...
        public InstNumber getInstance () {
            return this.instance;
        }

        

        public void setInstance (InstNumber value) {
            this.instance = value;
        }
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(Poc_AlertEntry.class);
