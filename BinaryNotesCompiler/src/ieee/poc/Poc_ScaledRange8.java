...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "Poc_ScaledRange8", isSet = false )
    public class Poc_ScaledRange8 implements IASN1PreparedElement {
	...
	private INT_U8 upper_scaled_value = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(Poc_ScaledRange8.class);
