...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "Poc_SaCalData32", isSet = false )
    public class Poc_SaCalData32 implements IASN1PreparedElement {
	...
	private INT_U32 increment = null;
	...
	private Poc_SaCalDataType cal_type = null;
        ...
        public INT_U32 getIncrement () {
            return this.increment;
        }

        

        public void setIncrement (INT_U32 value) {
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(Poc_SaCalData32.class);
