...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "Poc_EnumRecordOo", isSet = false )
    public class Poc_EnumRecordOo implements IASN1PreparedElement {
  ...
  @ASN1Any( name = "" )
	...
	private byte[] record_data = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(Poc_EnumRecordOo.class);
