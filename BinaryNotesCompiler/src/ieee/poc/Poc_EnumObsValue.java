...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "Poc_EnumObsValue", isSet = false )
    public class Poc_EnumObsValue implements IASN1PreparedElement {
	...
	private Poc_EnumVal value = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(Poc_EnumObsValue.class);
