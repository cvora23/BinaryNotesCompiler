...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "Poc_DeleteArgument", isSet = false )
    public class Poc_DeleteArgument implements IASN1PreparedElement {
	...
	private Poc_Scope scope = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(Poc_DeleteArgument.class);
