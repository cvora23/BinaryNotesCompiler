...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "Poc_ObservationPoll", isSet = false )
    public class Poc_ObservationPoll implements IASN1PreparedElement {
	...
	private AttributeList attributes = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(Poc_ObservationPoll.class);
