...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "Poc_ScaledRange32", isSet = false )
    public class Poc_ScaledRange32 implements IASN1PreparedElement {
	...
	private INT_U32 upper_scaled_value = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(Poc_ScaledRange32.class);
