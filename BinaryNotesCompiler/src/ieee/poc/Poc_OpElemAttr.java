...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "Poc_OpElemAttr", isSet = false )
    public class Poc_OpElemAttr implements IASN1PreparedElement {
	...
	private AttributeList attributes = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(Poc_OpElemAttr.class);
