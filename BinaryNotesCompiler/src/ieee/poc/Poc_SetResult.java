...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "Poc_SetResult", isSet = false )
    public class Poc_SetResult implements IASN1PreparedElement {
	...
	private AttributeList attributeList = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(Poc_SetResult.class);
