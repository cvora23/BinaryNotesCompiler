...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "Poc_GetError", isSet = false )
    public class Poc_GetError implements IASN1PreparedElement {
	...
	private OID_Type attributeId = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(Poc_GetError.class);
