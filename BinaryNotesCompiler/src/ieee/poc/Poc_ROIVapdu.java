...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "Poc_ROIVapdu", isSet = false )
    public class Poc_ROIVapdu implements IASN1PreparedElement {
  ...
  @ASN1Any( name = "" )
	...
	private byte[] argument = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(Poc_ROIVapdu.class);
