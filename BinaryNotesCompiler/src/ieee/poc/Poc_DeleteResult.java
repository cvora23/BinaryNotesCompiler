...
import org.bn.types.*;
    ...
    @ASN1PreparedElement
    @ASN1Sequence ( name = "Poc_DeleteResult", isSet = false )
    public class Poc_DeleteResult implements IASN1PreparedElement {
	...
	private Poc_ManagedObjectId managedObject = null;
        ...
        private static IASN1PreparedElementData preparedData = CoderFactory.getInstance().newPreparedElementData(Poc_DeleteResult.class);
